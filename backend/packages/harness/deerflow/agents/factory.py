...
def create_deerflow_agent(
    ...
    *,
    ...
    name:
        Agent name (used for per-agent memory directory isolation).
...
def _assemble_from_features(
    ...
    *,
    ...
    # --- [9] Memory ---
    # Memory is now agent-driven via the memory tool, not middleware.
    # A custom middleware can still be passed via feat.memory.
    if feat.memory is not False and isinstance(feat.memory, AgentMiddleware):
