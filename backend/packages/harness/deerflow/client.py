...
class DeerFlowClient:
    ...
    def get_memory(self) -> dict:
        ...
        return {
            "memory": {"target": "memory", "entries": store.get_live_entries("memory"), "usage": f"{mem_usage['chars']}/{mem_usage['limit']} chars"},
            "user": {"target": "user", "entries": store.get_live_entries("user"), "usage": f"{usr_usage['chars']}/{usr_usage['limit']} chars"},
        }
